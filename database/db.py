...
_COLUMN_MIGRATIONS = [
    ...
    ("predictions", "roic",             "numeric"),
    ("predictions", "ev_to_ebitda",     "numeric"),
    ("predictions", "net_debt_to_ebitda", "numeric"),
    ("predictions", "fcf_yield",        "numeric"),
    ("predictions", "share_buyback_trend", "text"),
    ("predictions", "short_interest_pct", "numeric"),
    ...
    ("predictions", "live_return_pct",           "numeric"),
    ("predictions", "live_option_value",          "numeric"),
    ("predictions", "live_option_return_pct",     "numeric"),
    ("predictions", "live_option_price_updated_at", "timestamptz"),
    ("predictions", "live_signal_log",            "jsonb"),
    ("predictions", "live_signal_conviction",     "text"),
]
